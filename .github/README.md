...
This repository dogfoods the Atmos 1.222 native runtime path end to end:
...
- **[Native Git clone](https://atmos.tools/cli/configuration/git)** in GitHub Actions instead of `actions/checkout`.
