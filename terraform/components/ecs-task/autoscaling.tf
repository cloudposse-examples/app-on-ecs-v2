...
module "ecs_cloudwatch_sns_alarms" {
  ...
  cpu_utilization_high_alarm_actions = [module.ecs_cloudwatch_autoscaling[0].scale_up_policy_arn]
  ...
  cpu_utilization_low_alarm_actions = [module.ecs_cloudwatch_autoscaling[0].scale_down_policy_arn]
